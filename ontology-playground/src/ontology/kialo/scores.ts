...
// to), any other placement carries **impact**, which folds veracity and relevance to the parent
// into one number. See ./ontology.md. How a `[3,1]` row is lexed is shared, in ../scores.ts.
