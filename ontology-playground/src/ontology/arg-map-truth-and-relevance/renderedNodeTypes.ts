...
export const renderedNodeTypes: NodeTypeDef[] = [
  {
    ...
    label: "Claim",
    icon: "💬",
    description: "A statement worded so that believing it more or less makes sense.",
    shape: ['["', '"]'],
  ...
  },
  {
    ...
    label: "Supports",
    icon: "✅",
    description: "A link asserting that its source claim counts in favour of its target.",
    shape: ['(["', '"])'],
  ...
  },
  {
    ...
    label: "Critiques",
    icon: "⛔",
    description: "A link asserting that its source claim counts against its target.",
    shape: ['(["', '"])'],
  ...
  },
  {
    ...
    label: "Note",
    icon: "📝",
    description: "An annotation shown attached to its parent. Carries no score.",
    shape: ['[/"', '"/]'],
  ...
  },
  {
    ...
    label: "Topic",
    icon: "📋",
    description: "The document's %description, plus the %perspectives each score slot belongs to.",
    shape: ['[["', '"]]'],
