...
const syntaxEntries: LegendEntry[] = [
  ...
  },
  {
    marker: "[3,1]",
    label: "Votes",
    meaning: `A thesis's veracity or a claim's impact, ${MIN_SCORE}-${MAX_SCORE}, one slot per perspective. Use - for no vote.`,
    icon: "🔢",
  },
  {
    marker: "%perspectives",
    label: "Perspectives",
    meaning: "Who the vote slots belong to, in the order they're written.",
    icon: "👥",
  },
  {
    marker: "&id",
    label: "Label",
    meaning: "Give a claim an id so you can place it again.",
    icon: "🏷️",
  },
  {
    marker: "$id",
    label: "Link",
    meaning: "Place an existing claim here too. It keeps its own vote in each spot.",
    icon: "🔀",
  },
